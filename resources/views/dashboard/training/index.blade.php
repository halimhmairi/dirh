                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <a href="{{ Route('training.destroy',$training->id) }}" 
                                               ...
                                               onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette formation ?')" title="Supprimer">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-gray-600 text-lg font-medium">Aucune formation</p>
                                            <p class="text-gray-500 text-sm mt-1">Créez votre première formation</p>
                                            <a href="{{ Route('training.create') }}" 
