                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <a href="{{ Route('types.destroy',$type->id) }}" 
                                               ...
                                               onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce type de congé ?')"
                                               title="Supprimer">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-gray-600 text-lg font-medium">Aucun type de congé</p>
                                            <p class="text-gray-500 text-sm mt-1">Créez votre premier type de congé</p>
                                            <a href="{{ Route('types.create') }}" 
