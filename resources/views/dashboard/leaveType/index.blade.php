                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-700">
                                        <p class="line-clamp-2">{{ $type->description }}</p>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <a href="{{ Route('types.destroy',$type->id) }}" 
                                               ...
                                               onclick="return confirm('{{ __('messages.Are you sure you want to delete this leave type?') }}')"
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-gray-600 text-lg font-medium">{{ __('messages.No leave types') }}</p>
                                            <p class="text-gray-500 text-sm mt-1">{{ __('messages.Create your first leave type') }}</p>
                                            <a href="{{ Route('types.create') }}" 
