                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <a href="{{ Route('role.destroy',$role->id) }}" 
                                               ...
                                               onclick="return confirm('{{ __('messages.Are you sure you want to delete this role?') }}')"
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-gray-600 text-lg font-medium">{{ __('messages.No roles') }}</p>
                                            <p class="text-gray-500 text-sm mt-1">{{ __('messages.Create your first role') }}</p>
                                            <a href="{{ Route('role.create') }}" 
