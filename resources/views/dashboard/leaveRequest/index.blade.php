                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-gray-600 text-lg font-medium">{{ __('messages.No leave requests') }}</p>
                                            <p class="text-gray-500 text-sm mt-1">{{ __('messages.Create your first leave request') }}</p>
                                            <a href="{{ Route('request.create') }}" 
