                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('messages.Job title') }}</th>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <a href="{{ Route('jobs.destroy',$job) }}" 
                                               ...
                                               onclick="return confirm('{{ __('messages.Are you sure you want to delete this job?') }}')" title="{{ __('messages.Delete') }}">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-gray-600 text-lg font-medium">{{ __('messages.No jobs') }} d'emploi</p>
                                            <p class="text-gray-500 text-sm mt-1">{{ __('messages.Create your first job') }}</p>
                                            <a href="{{ Route('jobs.create') }}" 
