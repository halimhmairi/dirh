            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
                    <h2 class="text-xl font-bold text-white flex items-center gap-2">
                        ...
                        {{ __('{{ __('messages.Edit department') }}') }}
                    </h2>
                </div>

                <!-- Corps -->
                <div class="p-6">
                    <form method="POST" action="{{ Route('department.update') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea name="location" 
                                      ...
                                      class="block w-full px-4 py-3 border @error('location') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">{{ $department->location }}</textarea>
                            @error('location')
                                <p class="mt-2 text-sm text-red-600 flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
