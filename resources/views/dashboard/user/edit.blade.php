                    ...
                    <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   class="block w-full px-4 py-3 border @error('phone_number') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            @error('phone_number')
                                <p class="mt-2 text-sm text-red-600 flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="status" 
                                    ...
                                    <option value="active" @selected("Active" === $user->status)>{{  __('messages.Active') }}</option>
                                    <option value="blocked" @selected("blocked" === $user->status)>{{  __('messages.Blocked') }}</option>
                                    <option value="waiting" @selected("waiting" === $user->status)>{{  __('messages.Waiting') }}</option>
                                </select>
                                @error('status')
                                    <p class="mt-2 text-sm text-red-600 flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div>
                                ...
                                <select name="role_id" 
                                        id="role_id"
                                        class="block w-full px-4 py-3 border @error('role') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <div>
                            ...
                            <select name="department_id" 
                                    id="department_id"
                                    class="block w-full px-4 py-3 border @error('department_id') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
